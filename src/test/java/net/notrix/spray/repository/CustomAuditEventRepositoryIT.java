package net.notrix.spray.repository;

import net.notrix.spray.Spray6App;
import net.notrix.spray.config.Constants;
import net.notrix.spray.config.audit.AuditEventConverter;
import net.notrix.spray.domain.PersistentAuditEvent;
...
import static net.notrix.spray.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
